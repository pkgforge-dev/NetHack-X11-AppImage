...
source=("https://nethack.org/download/${pkgver}/nethack-${pkgver//./}-src.tgz"
        ...
        'gcc15-1.diff'
        'x11-fix.patch')
sha256sums=('2959b7886aac76185b90aea0c9f80d14343f604de0ae96b3dd2a760f7ab3bde9'
            ...
            '927509d9b42de18670d7d259b48eb28364f930683b739deabfd59ee6066bcb38'
            'c6e05ede2874f2f144d92355ee9efc5fde50df32f486f87dc7a67f7fcefa97a3')
...
prepare() {
  ...
  patch -Np1 -i "$srcdir/gcc15-1.diff"
  patch -Np1 -i "$srcdir/x11-fix.patch"
